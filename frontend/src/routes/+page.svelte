...
<div
	class="fixed bottom-2 right-2 top-2 w-96 overflow-y-auto rounded-lg bg-background bg-opacity-80 p-4 shadow-lg backdrop-blur-lg"
>
	...
	<div class="mt-4 space-y-2">
		...
		<Card.Root>
			...
			<Card.Content class="space-y-2">
				<div class="space-y-2 p-4 border-muted rounded-sm border">
